  ...
  return (
    <section className="relative flex h-[80vh] w-full cursor-default flex-col items-center justify-center bg-[url('/hero-4.jpg')] bg-cover bg-center bg-no-repeat py-40 text-white">
      ...
      <div className="relative z-10 w-[90%] text-center lg:w-3/5">
        ...
        <div className="relative mx-auto mt-8 flex w-full max-w-2xl items-center justify-center text-black">
          <input
            type="text"
            name="search"
            id="search"
            className="w-full rounded-full py-4 pl-6 pr-32 shadow-lg transition duration-300 ease-in-out focus:ring-2 focus:ring-emerald-300"
