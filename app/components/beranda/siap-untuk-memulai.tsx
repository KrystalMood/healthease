  ...
  return (
    <section className="relative mx-auto flex w-full cursor-default bg-gradient-to-t from-white to-gray-50 px-[5%] pt-28">
      ...
      <div className="relative flex w-full flex-col items-center rounded-xl bg-emerald-500 px-8 py-16 text-white">
        <h2 className="text-3xl font-bold md:text-4xl">Siap untuk memulai?</h2>
        ...
        <span className="mt-10 flex flex-col gap-3 lg:flex-row lg:gap-8">
          <Link to={`/reservasi`} className="flex items-center rounded-xl bg-white px-8 py-4 text-lg font-semibold text-emerald-600 transition-colors duration-200 hover:bg-emerald-50">
            Mulai Konsultasi
            <ArrowRight className="ml-2 h-5 w-5" />
          </Link>
          <Link to={`/layanan`} className="inline-flex items-center justify-center rounded-xl border-2 border-white px-8 py-4 text-lg font-semibold text-white transition-colors duration-200 hover:bg-emerald-400">
