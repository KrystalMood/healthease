...
export default function AlasanMemilihKami(): JSX.Element {
  return (
    <section className="mx-auto mt-20 flex max-w-full cursor-default items-center justify-between gap-x-20 bg-gradient-to-br from-emerald-950 to-emerald-900 px-[7.5%]">
      ...
      <div className="flex flex-col py-14 lg:py-28">
        ...
        <div className="mt-10 flex flex-col gap-y-5">
          {AlasanMemilihProps().map((list) => (
            <figure key={list.id} className="group relative overflow-hidden rounded-2xl border border-emerald-100/20 bg-emerald-100/10 p-6 transition-all duration-300 ease-in-out lg:hover:border-emerald-100/40 lg:hover:bg-emerald-100/20">
              ...
              <figcaption className="h-0 text-white opacity-0 transition-all duration-300 group-hover:h-auto group-hover:opacity-100">
                {list.description}
              </figcaption>
            </figure>
          ))}
